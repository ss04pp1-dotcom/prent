...
/**
 * Android Keystore-backed RSA wrapper for screenshot content keys.
 * 
 * Flow:
 *   - Parent generates RSA KeyPair in Android Keystore.
 *   - Parent exports public key to Base64 and sends to Child during pairing.
 *   - Child encrypts random AES-256 content key with Parent's RSA public key.
 *   - Parent decrypts AES-256 content key with its RSA private key.
 */
class KeystoreManager(
    private val context: Context,
) {
    /**
     * Gets or creates the RSA key pair for the Parent, and returns the Public Key
     * encoded in Base64 format (X.509).
     */
    ...
    /**
     * Parent: Unwraps the AES content key using its RSA private key.
     */
    ...
    /**
     * Child: Wraps the AES content key using the Parent's RSA public key.
     */
    ...
    private companion object {
        ...
        const val MASTER_KEY_ALIAS = "pc_parent_rsa_master"
